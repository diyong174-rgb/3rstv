...
// Sample channel data structure with CABLE, YOUTUBE, MOVIES, RADIO categories
const channels = {
  CABLE: [
  ...
  { name: 'Celestial Classic Movies', url: 'https://linearjitp-playback.astro.com.my/dash-wv/linear/100/default_ott.mpd', type: 'mpd', keyId: 'a642dd4bf3ea782e19202adefb604b10', key: '3f59355e15eed1bb219ea1687d55cfbb', logo: '' }
   ...
   MOVIES: [
         ...
         { name: 'Virgen People 2', url: 'https://jungotvmedia.chanall.tv/jungotv/SOLARVirginPeople2Version2TGFULL10mbps/playlist_720p.m3u8', type: 'movies', logo: '' },
...
function showChannelList(category) {
  ...
  if (channelList.length > 0) {
    playChannel(channelList[0]);  // Automatically play the first channel in CABLE
  }
}
...
// Show IPTV content after a delay (simulating data fetching)
setTimeout(() => {
...
}, 3000); // 3 seconds delay to simulate content loading

// Messenger and Donate functions
function openMessenger() {
  window.location.href = "m.me/865912119931849";  // Replace with your Messenger page or app link
}

function openDonateLink() {
  window.location.href = "https://www.paypal.com/donate?hosted_button_id=yourbuttonid";  // Replace with your donation link
}
